...
// ── Slide images — update paths to match your actual 2-bedroom photos ──
import slide1 from "../assets/images/twoliving.png";
import slide2 from "../assets/images/twobedroom.png";
import slide3 from "../assets/images/twokitchen.png";
import slide4 from "../assets/images/twobathroom.png";
...
const FEATURES = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="w-5 h-5">
        <path d="M3 7v11M3 12h18M21 7v11M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2" />
        <path d="M7 12V9h10v3" />
      </svg>
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="w-5 h-5">
        <path d="M20 9V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2M2 11v5a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v2H6v-2a2 2 0 0 0-4 0z" />
      </svg>
    ),
  },
];
...
const TOUR_SPOTS = [
  {
    label: "Living Room",
    description: "Spacious, warmly decorated living room with a Smart TV, DSTV channels, and comfortable seating for the whole group.",
    image: slide1,
  },
  {
    label: "Main Bedroom",
    description: "Generously sized main bedroom with comfortable bedding, large closet, and a Smart TV.",
    image: slide2,
  },
  {
    label: "Kitchen",
    description: "Modern kitchen fitted with premium appliances — everything you need to cook a full meal.",
    image: slide3,
  },
  {
    label: "Bathroom",
    description: "Two private bathrooms with hot water, fresh towels, and toiletries provided.",
    image: slide4,
  },
];
      ...
      <div className="relative h-[60vh] min-h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[2] max-w-6xl mx-auto px-6 pb-10">
          ...
          <h1 className="font-serif font-bold text-white text-[clamp(2rem,5vw,3.5rem)] leading-tight">
            PhilGood <span className="text-[#F5A623] italic">2-Bedroom Suite</span>
          </h1>
            ...
            <div className="flex-1">
              ...
              <div className="mb-10">
                ...
                <p className="font-sans text-gray-500 text-sm leading-relaxed mb-4">
                  Relax in our warmly decorated 2-bed/2-bath apartment. There is fast broadband internet throughout. The main bedroom and living room each have a TV with DSTV channels from across the world and local TV.
                </p>
                <p className="font-sans text-gray-500 text-sm leading-relaxed mb-4">
                  The kitchen is fitted with modern appliances to delight the chef in you! We have a standby generator to provide continuous power and outdoor CCTV monitoring.
                </p>

                {/* Space + Guest access callouts */}
                <div className="flex flex-col gap-4 mt-6">
                  <div className="flex gap-3 bg-white rounded-xl p-4 border border-gray-100">
                    <div className="text-[#E8691A] flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <p className="font-sans font-semibold text-[#1a1a1a] text-xs uppercase tracking-widest mb-1">The Space</p>
                      <p className="font-sans text-gray-500 text-sm">Comfortable beddings in all rooms and spaces are very spacious. Large closets.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 bg-white rounded-xl p-4 border border-gray-100">
                    ...
                    <div>
                      <p className="font-sans font-semibold text-[#1a1a1a] text-xs uppercase tracking-widest mb-1">Guest Access</p>
                      <p className="font-sans text-gray-500 text-sm">Full access to the apartment.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
                {[
                  ...
                  <div key={stat.label} className="bg-white rounded-xl p-4 text-center border border-gray-100">
                    <p className="font-serif font-bold text-[#1a1a1a] text-base lg:text-lg">{stat.value}</p>
              ...
              <div className="sticky top-24 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="bg-[#0f1e2e] px-6 py-5">
                  <div className="flex items-baseline gap-1">
                    <span className="font-serif font-bold text-white text-3xl">$70</span>
                ...
                <div className="p-6 flex flex-col gap-4">
                  ...
                  <div className="pt-2 border-t border-gray-100">
                    <p className="font-sans text-gray-400 text-xs text-center mb-2">Other options</p>
