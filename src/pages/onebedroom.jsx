...
const TOUR_SPOTS = [
  {
    label: "Living Room",
    description: "Spacious open-plan living area with plush seating, mood lighting, and a Smart TV.",
    image: slide3,
  },
  {
    label: "Bedroom",
    description: "Private, fully furnished bedroom with a king-size bed, blackout curtains, and wardrobe.",
    image: slide4,
  },
  {
    label: "Kitchen",
    description: "Fully equipped kitchen with gas cooker, microwave, fridge, and all cookware.",
    image: slide1,
  },
  {
    label: "Bathroom",
      ...
      <div className="relative h-[60vh] min-h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[2] max-w-6xl mx-auto px-6 pb-10">
          ...
          <h1 className="font-serif font-bold text-white text-[clamp(2rem,5vw,3.5rem)] leading-tight">
            PhilGood <span className="text-[#F5A623] italic">1-Bedroom Suite</span>
          </h1>
            ...
            <div className="flex-1">
              ...
              <div className="mb-10">
                ...
                <p className="font-sans text-gray-500 text-sm leading-relaxed mb-4">
                  Our 1-Bedroom Suite is the perfect choice for couples, solo travellers on extended stays, or anyone who wants a little more room to breathe. With a fully separate bedroom and a generous living area, you get the privacy of home with the comfort of a premium hotel.
                </p>
                <p className="font-sans text-gray-500 text-sm leading-relaxed">
                  The suite is fully furnished with high-quality pieces, a well-equipped kitchen for home cooking, and a private bathroom stocked with everything you need. Nestled in the safe, serene community of East Legon Hills — close to everything Accra has to offer.
                </p>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4 mb-10">
                {[
                  { label: "Type", value: "1-Bedroom" },
                  { label: "Guests", value: "1 – 2" },
                  { label: "Bedroom", value: "1 Private" },
              ...
              <div className="sticky top-24 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="bg-[#0f1e2e] px-6 py-5">
                  <div className="flex items-baseline gap-1">
                    <span className="font-serif font-bold text-white text-3xl">$50</span>
